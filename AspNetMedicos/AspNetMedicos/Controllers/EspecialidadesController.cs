...
namespace AspNetMedicos.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EspecialidadesId,nome")] Especialidades especialidades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EspecialidadesId,nome")] Especialidades especialidades)
        {
            if (ModelState.IsValid)
            {
